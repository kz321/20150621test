        ...
        function onDeviceReady() {
            ...
            try {
                ...
                if (device.platform == 'android' || device.platform == 'Android') {
                    pushNotification.register(successHandler, errorHandler, { "senderID": "957974317066", "ecb": "onNotification" });		// required!
                ...
                case 'registered':
                    if (e.regid.length > 0) {
                        ...
                        */
                        ...
                        var request = $.ajax({
                            url: "https://163.15.192.205/vany/index.php/mobile/regid",
                            type: "POST",
                            cache: false,
                            crossDomain: true,
                            success:
